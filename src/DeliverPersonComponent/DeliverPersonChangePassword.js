...
function DeliverPersonChangePassword(props) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (newPassword === confirmPassword) {
            if (oldPassword === confirmPassword) {
               ...
               const d= await DeliverPersonService.changePassword(objects.email, oldPassword, confirmPassword)
                    .then((response) => {
                        setSuccess(true);
                        setFailure(false)
                    }).catch((error) => {
...
export default DeliverPersonChangePassword